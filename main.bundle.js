...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getFromLocal\": () => (/* binding */ getFromLocal),\n/* harmony export */   \"reload\": () => (/* binding */ reload),\n/* harmony export */   \"saveLocal\": () => (/* binding */ saveLocal)\n/* harmony export */ });\n/* harmony import */ var _iteration__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./iteration */ \"./src/iteration.js\");\n\nconst saveLocal = (key,value) => {\n    localStorage.setItem(key, JSON.stringify(value));\n}\n\nconst getFromLocal = (key) => {\n  const stored = JSON.parse( localStorage.getItem(key))\n  let storedTasks = [];\n  if (stored) {\n    for (let i = 0;i < stored.length ;i += 1) {\n      storedTasks.push(stored[i])\n\n    }\n  }\n  return storedTasks;\n}\n\nconst reload = () => {\n  const store = getFromLocal(\"tasks\");\n  console.log(store);\n  (0,_iteration__WEBPACK_IMPORTED_MODULE_0__.listItem)(store);\n};\n\n\n//# sourceURL=webpack://webpack-template/./src/localstorage.js?");
